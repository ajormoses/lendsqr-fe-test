      ...
      <div className="login-content">
        <div className="container">
          ...
          <div className="login-content-intro">
            <div className="login-content-intro-design">
              <img src="./images/pablo-sign-in.png" alt="design" />
            </div>
            <form className="login-content-intro-form">
              <div className="login-content-intro-form-header">
                <h1>Welcome!</h1>
                <p className="light">Enter details to login.</p>
              </div>
              <div className="login-content-intro-form-input">
                <div className="login-content-intro-form-input-email">
                  <input type="email" placeholder="Email" />
                </div>
                <div className="login-content-intro-form-input-password">
                  {show ? (
